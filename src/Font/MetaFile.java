...
public class MetaFile {
	 ...
	 *            - the font file.
	 */
	protected MetaFile(InternalJarFile file) {
	...
	private boolean processNextLine() {
		...
		for (int i = 0; i < line.split(SPLITTER).length; i++) {
			String part = line.split(SPLITTER)[i];
	 ...
	 *            - the font file.
	 */
	private void openFile(InternalJarFile file) {
		reader = ResourceStreamReader.getResourceReader(file.getPath());
	}
